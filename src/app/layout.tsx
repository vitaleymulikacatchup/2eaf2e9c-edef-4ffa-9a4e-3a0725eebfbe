...
export const metadata: Metadata = {
  title: "Medicide - Premium Medicinal Cannabis Products",
  description: "Quality medicinal cannabis products for pain relief, sleep support, and wellness. Professional-grade formulations backed by research.",
  keywords: "medicinal cannabis, CBD products, THC products, cannabis wellness, pain relief, sleep support, therapeutic cannabis",
  metadataBase: new URL("https://medicide.com"),
  alternates: {
    canonical: "https://medicide.com"
  },
  openGraph: {
    title: "Medicide - Premium Medicinal Cannabis",
    description: "Discover our pharmaceutical-grade cannabis products for wellness and healing",
    url: "https://medicide.com",
    siteName: "Medicide",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764004870291-p9hnwk3p.jpg",
        alt: "Medicide premium cannabis products"
      }
    ]
  },
  twitter: {
    ...
    title: "Medicide - Premium Medicinal Cannabis",
    description: "Quality cannabis products for wellness and therapeutic benefits",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764004870291-p9hnwk3p.jpg"]
  },
  robots: {
    index: true,
    follow: true
